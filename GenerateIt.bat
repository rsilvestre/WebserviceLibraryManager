...
svcutil C:\Tmp\WebsIFAC.ItemIFAC.wsdl c:\Tmp\*xsd /out:C:\Tmp\ItemIFAC.cs /async /ct:System.Collections.Generic.List`1 /r:C:\VS2013\WebservicePerso\IFAC\bin\Debug\WebsBO.dll /n:*,WCF.Proxies /noConfig
